            ...
            //var result = removeDuplicates(data);
                ...
                //var feedback = data[0]['feedback'];
                    ...
                    POINTS.push(questionid);
										...
										html+='<div style="font-size:26px;" <b><p>Points: </b><textarea rows="1" id="changedPoints'+questionid+'" style="width:4%; height:4%; padding:4px; border-style:solid; border-width:2px;font-size:16px;" id="'+data[i]['questionid']+'">'+pointsgot+'</textarea>&nbsp;/&nbsp;'+pointstotal+'</p></div>';
                  ...
                  html += '<td style="width:8% ;text-align:center;" >'+Functioncheck+'</td>';
                    ...
                    html+='<br><br>';
                     ...
                     html+='<hr>';
										...
										html+='<br><br><input type="button" value="Submit Changes" class="submitbutton" onclick="submit();"/>';
										html+='</div></div>';
										Display.innerHTML=html;
