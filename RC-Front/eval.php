...
ajaxRequest.onreadystatechange = function(){
	...
	html+='<br><br><input type="button" value="Review Exam" class="submitbutton" onclick="reviewexam();"/>';
            ...
            //var result = removeDuplicates(data);
                ...
                //var feedback = data[0]['feedback'];
                    ...
                    POINTS.push(questionid);
										...
										html+='<div align="middle" style="border-left:6px;"><br><textarea rows="10" style="width:30%;border:solid 2px black;font-size:20px;" id="'+data[i]['questionid']+'" readonly>'+answer +'</textarea><br><br></div>';
                    html+='<div style="font-size:26px;"<b><p>Points: </b><textarea rows="1" id="changedPoints'+questionid+'" style="width:4%; height:4%;padding:4px; border-style:solid; border-width:2px;font-size:16px;" id="'+data[i]['questionid']+'" readonly>'+changedPoints+'</textarea>&nbsp;/&nbsp;'+pointstotal+'</p></div>';
                   ...
                   for(k=0;k<caseHit.length;k++){
                     var casePassed = data[i]['0'][k]['casePassed'];
                      ...
                      console.log(run);
										 ...
										 html += "<tr id='review2' style='width:25%;' height: 40px; >";
                  ...
                  html += '<td style="width:8% ;text-align:center;">'+Functioncheck+'</td>';
                    ...
                    html+='</tbody></table>';
                    html+='<br><br>';
                     html+='<div align="middle" style="border-left:6px;"><label style="font-size:22px;">Feedback</label><br><textarea rows="10" id="feedback'+questionid+'" style="width:50%; border-style:solid; border-width:2px;font-size:20px;" id="'+data[i]['questionid']+'" readonly>'+feedback+'</textarea><br><br></div>';
