...
<center>
 ...
 <!--Question Bank HTML and styles -->
      ...
      <br>
       	...
       	<textarea style="margin-left:50px;font-size:17px;" rows=10 cols="80" name="description" id="description"  placeholder="Enter a question here...."></textarea>
     ...
     <br>
      ...
      <label >Type
          ...
          <option value="factorial">factorial</option>
			...
			<label align="middle" style="float:none;">Difficulty
     ...
     <br>
      ...
      <div id="cases" align="middle" style="float:none;">

          Case 1<input type="text" id="testcases" name="myInputs[]" style="font-size:17px;">

          Case Answer 1<input type="text" id="testcaseAns" name="myInputs[]" style="font-size:17px;">



       </div>
       <input type="button" value="Add another test case" id="test" onClick="addInput('cases');" align="middle" style="float:none;" >
       <br>
       <br>
       <br>

      <input type="button" class="submitbutton" value="Submit" onclick="addQuestion();" align="middle" style="float:none;">
...
function addInput(divID){
     if (counter == limit)  {
          ...
          newdiv.innerHTML = "<label id='text1'>" +  "Case " + (counter + 1) + "<input type='text' name='myInputs[]' style='float:none;font-size:17px;' > ";
          newdiv.innerHTML += "<label id='text2'>" + "Case Answer " + (counter + 1) + "<input type='text' name='myInputs[]' style='float:none;font-size:17px;'><br>"
...
xhr.onreadystatechange = function(){
   ...
   console.log(res);
		...
		lefthtml+="<thead style='background-color:#42ABCA; color:white;'><tr>";
...
*/
			...
			lefthtml+='<td hidden name="questionlist" id="'+data[i]['id'];
			lefthtml+='" value="'+data[i]['id']+'"'+'></td>';
      
      //lefthtml+="name='questionlist' id='"+"tr"+data[i]['id']+"'</td>";
