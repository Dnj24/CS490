...
<body>
   ...
   <div class = "textbox" >
			<input type="text" placeholder='Exam Title' style=" transform: scale(2.0); position:center;" name="examname" id="examname">
          &nbsp
          &nbsp
          &nbsp
          &nbsp
          ...
          &nbsp
          &nbsp
            <input type="button" class="submitbutton" value="Done" style=" margin-right:40px;" onclick="addExam();">
            </div>
   ...
   console.log(res);
    ...
    righthtml+="<table id='review'>";
      ...
      lefthtml+='<td id="'+data[i]['questionid']+'">'+stringhit+'</td>';
			...
			righthtml+='placeholder="Input Points" style="border:none;width:100%;height:25px;font-size:14px;"/></td>';
